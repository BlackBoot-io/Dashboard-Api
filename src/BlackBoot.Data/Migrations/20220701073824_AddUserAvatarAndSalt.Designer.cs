...
namespace BlackBoot.Data.Migrations
{
    ...
    [Migration("20220701073824_AddUserAvatarAndSalt")]
    partial class AddUserAvatarAndSalt
    {
            ...
            modelBuilder.Entity("BlackBoot.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("822f1c27-599f-4ba0-813c-8a664c46548a"),
                            BirthdayDate = new DateTime(2022, 7, 1, 12, 8, 24, 121, DateTimeKind.Local).AddTicks(2381),
                            ...
                            RegistrationDate = new DateTime(2022, 7, 1, 12, 8, 24, 121, DateTimeKind.Local).AddTicks(2349)
                        });
                });
